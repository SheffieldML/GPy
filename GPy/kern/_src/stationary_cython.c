 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_12, __pyx_t_5, __pyx_t_14, __pyx_t_4, __pyx_t_10, __pyx_t_7, __pyx_t_9, __pyx_t_8, __pyx_t_15, __pyx_t_11, __pyx_t_13, __pyx_t_6)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_n) lastprivate(__pyx_v_m) lastprivate(__pyx_v_d) firstprivate(__pyx_v_nd) lastprivate(__pyx_v_nd)
                    #endif /* _OPENMP */
 ...
 */
  ...
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(7, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_james_work_GPy_GPy_kern, __pyx_n_s_lengthscale_grads, 51, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
