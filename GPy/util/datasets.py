...
def mauna_loa(data_set='mauna_loa', refresh_data=False):
    path = os.path.join(data_path, data_set)
    ...
    X = data[data[:, 3]>100, 2:3]
    Y = data[data[:, 3]>100, 3:4]
    return data_details_return({'X': X, 'Y': Y, 'info': "Mauna Loa data as cached on your local system."}, data_set)
